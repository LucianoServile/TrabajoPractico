...
public class Liga extends Combatiente {
	...
	public Liga(String nombre, Equipo equipo, int velocidad, int fuerza,
			int resistencia, int destreza, HashSet<Combatiente> combatientes) {
	...
	public void agregarCombatiente(Combatiente combatiente) {
		...
		if (this.getEquipo() == combatiente.getEquipo()) {
			...
			System.err.println(combatiente.getNombre()
					+ " No es del mismo equipo");
		}
