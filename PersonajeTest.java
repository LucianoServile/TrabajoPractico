...
public class PersonajeTest {
	...
	public void enfrentamientoPorVelocidadTest() {
		Combatiente p1 = new Heroe("Tony Stark", Equipo.HEROE, "Iron Man", 99, 98, 90, 84);
		Combatiente p2 = new Villano("Thanos", Equipo.VILLANO, "Thanos", 89, 83, 98, 96);
	...
	public void enfrentamientoPorFuerzaTest() {
		Combatiente p1 = new Heroe("Tony Stark", Equipo.VILLANO, "Iron Man", 98, 92, 90, 84);
		Combatiente p2 = new Villano("Thanos", Equipo.HEROE, "Thanos", 100, 98, 98, 96);
	...
	public void enfrentamientoPorDestrezaTest() {
		Combatiente p1 = new Heroe("Tony Stark", Equipo.HEROE, "Iron Man", 98, 88, 90, 84);
		Combatiente p2 = new Villano("Thanos", Equipo.VILLANO, "Thanos", 100, 98, 98, 96);
	...
	public void enfrentamientoPorVelocidadEmpataDefinePorFuerza() {
		Combatiente p1 = new Heroe("Tony Stark", Equipo.HEROE, "Iron Man", 50, 88, 90, 84);
		Combatiente p2 = new Villano("Coronel Rhoades", Equipo.VILLANO, "Maquina de guerra", 50, 98, 98, 96);
	...
	public void enfrentamientoPorFuerzaEmpataDefinePorDestreza() {
		...
		Combatiente p2 = new Villano("Thanos", Equipo.VILLANO, "Thanos", 50, 98, 98, 96);
	...
	public void enfrentamientoPorResistenciaEmpataDefinePorDestreza() {
		Combatiente p1 = new Heroe("Steve Rogers", Equipo.HEROE, "Capitan America", 50, 98, 90, 84);
		Combatiente p2 = new Villano("Bucky Barnes", Equipo.VILLANO, "Soldado del Invierno", 50, 98, 90, 96);
	...
	public void enfrentamientoEmpataEnTodosLosAspectos() {
		Combatiente p1 = new Heroe("Steve Rogers", Equipo.HEROE, "Capitan America", 50, 98, 90, 96);
		Combatiente p2 = new Villano("Craneo rojo", Equipo.VILLANO, "Craneo Rojo", 50, 98, 90, 96);
