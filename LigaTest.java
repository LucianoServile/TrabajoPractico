...
//	@Test
//	public void devuelveErrorSiListaDeCombatienteNOEstaOrdenadosDeSuVelocidad() {
//		HashSet<Combatiente> combatientes = new HashSet<Combatiente>();
//		Combatiente c1 = new Villano("Batman","a", 1, 2, 7, 4);
//		Combatiente c2 = new Villano("Superman","a", 5, 3, 4, 2);
//		Combatiente c3 = new Villano("WonderWoman","a", 3, 1, 6, 3);
...
//		liga.agregarCombatiente(c2);
//		liga.agregarCombatiente(c3);
//		System.out.println(liga.listarCombatienteOrdenado(Caracteristica.VELOCIDAD));
//		System.out.println(liga.compare(c1, c2));
//		
//		int[] resultadoOrdenado = {1,3,5};
//		Assert.assertEquals(resultadoOrdenado, liga.listarCombatienteOrdenado(Caracteristica.VELOCIDAD));
//		
...
//	@Test
//	public void devuelveMayorDeCompare() {
//		HashSet<Combatiente> combatientes = new HashSet<Combatiente>();
//		Combatiente c1 = new Villano("Batman","a", 1, 2, 7, 4);
//		Combatiente c2 = new Villano("Superman","a", 5, 3, 4, 2);
//		Combatiente c3 = new Villano("WonderWoman","a", 3, 1, 6, 3);
...
//		liga.compare(c1, c2);
//		
//		Assert.assertEquals(1, liga.compare(c2, c1));
//	}
//	
//	@Test
//	public void devuelveMenorDeCompare() {
//		HashSet<Combatiente> combatientes = new HashSet<Combatiente>();
//		Combatiente c1 = new Villano("Batman","a", 1, 2, 7, 4);
//		Combatiente c2 = new Villano("Superman","a", 5, 3, 4, 2);
//		Combatiente c3 = new Villano("WonderWoman","a", 3, 1, 6, 3);
...
//		liga.compare(c1, c2);
//		
//		Assert.assertEquals(-1, liga.compare(c1, c2));
//	}
